...
@Component
public class SaltySnackCompletenessHealthCheck extends AbstractCompletenessHealthCheck implements HealthCheck {

    @Autowired
    public SaltySnackCompletenessHealthCheck(final RetailerService retailerService) {
    ...
    String getTypeClause(Retailer retailer) {
        return retailer.saltySnacksClause();
    }
}
